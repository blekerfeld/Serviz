...
class pDataModel {
	...
	public static function getRecordsOrdered($table, $order = 1, $where = 1){
		return p::$db->cacheQuery("SELECT * FROM ".$table." WHERE ". $where. " ORDER BY ".$order)->fetchAll();
	}
