...
define('CONFIG_DB_DATABASE', 'serviz');
...
if (version_compare(phpversion(), CONFIG_REQUIRED_PHP_VERSION, '<'))
	die('We are sorry, but Serviz requires PHP version '.CONFIG_REQUIRED_PHP_VERSION." in order to work.");
